package second_week.metodyundsuszarken.pralkosuszara;
...
public class pralkosuszara implements Pralka, Suszarka {
    ...
    public static void main(String[] args) {
        pralkosuszara pralkoSuszarka = new pralkosuszara();
